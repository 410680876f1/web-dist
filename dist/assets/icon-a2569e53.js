import{aJ as l,cJ as h,cq as e,cK as o,cL as n,cM as p,cN as m,cO as f,cP as t,cQ as d,cR as F,cS as v,cT as M,cU as u,cV as E,cW as H,cX as B}from"./index-d777c8ff.js";import{l as I,m as V,q as A,r as k}from"./index-2e555483.js";import{I as x}from"./Layout-36ec1d25.js";import{a as L}from"./index-6f07be45.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function D(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function g(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":F,"exe,msi":v,apk:x,db:I,md:M,epub:V,iso:A,m3u8:t,"doc,docx":u,"xls,xlsx":E,"ppt,pptx":H,pdf:B,psd:D,ai:Z,url:k,cast:L},N=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case c.FOLDER:return d;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return m;case c.IMAGE:return p;default:return n}},O=a=>N(a.type,a.name);export{g as A,c as O,O as g};
